...
| C. Order publik + QRIS | `public_order_screen.dart` (614) + controller (204) | `PublicOrderScreen.jsx` (1 route `/order`, 3 fase state) + gate App.jsx + tombol "Pesan tanpa akun" di Login + `public/payments/qris-statis.png` | 9 (dari 9 test controller Flutter + gate) |
