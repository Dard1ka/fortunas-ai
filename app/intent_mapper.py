...
INTENT_CONFIG = {
    ...
    "revenue_trend": {
        "strong_phrases": [
            ...
            "perkembangan omzet",
            "naik turun omzet",
            "bagaimana tren omzet saya",
            "penjualan saya naik atau turun",
            "revenue trend",
        ],
        "keywords": [
            "tren",
    ...
    "churn_risk": {
        "strong_phrases": [
            ...
            "customer yang berhenti belanja",
            ...
            "siapa pelanggan yang mau pergi",
        ],
        "keywords": [
            "churn",
            "berhenti belanja",
    ...
    "slow_moving_product": {
        "strong_phrases": [
            ...
            "barang yang lama tidak laku",
            "produk slow moving",
            "slow moving",
            "produk yang jarang dibeli",
            "barang yang jarang laku",
            "produk mati",
    ...
    "average_basket_size": {
        "strong_phrases": [
            ...
            "basket size",
            "average basket",
            "berapa rata rata orang belanja",
